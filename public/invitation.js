...
    { id: 14, name: "Ibrahim & Raghida Sarkis", allowed: 2 },
...
    { id: 25, name: "Wahid Al Ahmar & Family", allowed: 4 },
...
  ];
  ...
  function applyStrings(s) {
    ...
    document.getElementById("locationTitle").textContent = s.locationTitle.replace(/\n/g, "<br>");
